...
<ul>
    ...
    <li>To assist people you have done business with.  For example if you are an owner and a traveler who has booked or inquired with you needs your details we may pass them on; if you are a traveler and an owner you have booked with needs to contact you we may give them your details;</li>
    <li>To customize, measure, report on and improve our services, content and advertising;</li>
    <li>To promote services related to the Site or those of the BookingPal and/or our affiliates;</li>
...
<p>If you are a member, we will also be able to contact you about your account and your use of our services</p>

<h4>How We May Disclose Your Personal Data</h4>
...
<ul>
    ...
    <li>Companies in the BookingPal and/or affiliates; or</li>
    <li>Other companies or business entities, for example if we are thinking of a merger with or sale to that  company or business entity; or</li>
    <li>Other companies we work with to feature all or part of our member&#39;s property listings or otherwise provide promotional or other services related to our or BookingPal&#39;s business.  This might include featuring your listings and photographs on other websites; or</li>
...
<h4>Games</h4>
<p>From time to time we may run games on the Site. These games may allow for connectivity with other users or third parties.  If that is the case you consent to your personal data being transferred accordingly.</p>

<h4>Telephone Calls</h4>
<p>As well as collecting data online and from correspondence we may also speak with you face to face (for example at an Owner&#39;s meeting) or by telephone.  We frequently record telephone conversations.  Those recordings are also governed by this Privacy Policy and we keep this data in the same way that we keep other data.  Recordings of calls may also be transferred to locations or processed worldwide.</p>

<h4>Inquiries</h4>
<p>Travelers may send inquiries to members via clickable links on the listings on the Site. If you choose to send an inquiry through these links, your personal information, including your email address and any other information you supply, will be visible to the member in question so that they might reply directly to you.  Your details may also be sent to us and we may have access to those communications even if you contact the member directly.  Additionally those messages may be hosted on, be processed by or transmit through our servers.  If you call the member, you may be asked to leave a return telephone number. Do not share information in the e-mail or phone call that you are not prepared to allow them and BookingPal to have, including, but not limited to, credit card and bank account information. Inquiries can be sent to the individual member you selected and to our system. The resulting inquiry is available for review by the member to whom it was initially addressed and to our customer service people, who may share past inquiry information, or information related to past stays including your contact details with members. We may also from time to time, use third party e-mail servers to send and track receipt of inquiry emails, and analyze the pattern of inquiry usage reported by these third party tracking systems.</p>

<h4>How Do We Protect Your Personal Information Once We Have It?</h4>
...
<p>You can reduce the information cookies collect from your device.  An easy way of doing this is often to change the settings in your browser. If you do that you should know that (a) your use of the Site may be adversely affected (and possibly entirely prevented), (b) your experience of this and other sites that use cookies to enhance or personalize your experience may be adversely affected, and (c) you may not be presented with advertising that reflects the way that you use our and other, sites. You find out how to make these changes to your browser at this site: <a target="_blank" href="http://www.allaboutcookies.org/manage-cookies/">www.allaboutcookies.org/manage-cookies/</a>. Unless you have adjusted your browser setting so that it will refuse cookies, our system will send cookies as soon as you visit our site.  By using the site you consent to this, unless you change your browser settings.</p>
...
<p>You may opt-out of receiving marketing communications from us by the following means: </p>

<ol>
    <li>Contact us at <a href="mailto:support@mybookingpal.com">Customer Support</a>;</li>
    <li>Follow the instructions included in each communication or newsletter;</li>
    <li>Use the Unsubscribe function; or</li>
    <li>Mail the request to us at BookingPal, Inc. 101 Pacifica, Suite 250, Irvine, CA    92618.</li>
</ol>
...
<p>We will retain your personal data only as long as is necessary for the purposes to which you consent under the Terms and Conditions and this Privacy Policy, or as is required by applicable law, and then we will delete it.</p>

<h4>How do I contact you?</h4>
<p>If you have any questions about this Privacy Policy, the practices of this Site, or your dealings with this Site, we encourage you to contact us at <a href="mailto:support@mybookingpal.com">Customer Support</a>.</p>');
