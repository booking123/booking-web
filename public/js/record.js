...
(function( $ ) {
			...
			init : function(options) {
				...
				return this.each(function(i, e) {
					localize(function() {
						...
						if (settings.error) console.log("record " + settings.pos + ", " + settings.service + ", " + settings.id + ", " + settings.error);
						...
						.error(function(data) {if (settings.error) console.log("record error");});
					});	
				});
			},
		id : function( id ) {
	...
	$.fn.record = function( method ) {
		if ( methods[method] ) {return methods[ method ].apply( this, Array.prototype.slice.call( arguments, 1 ));}
		else if ( typeof method === "object" || ! method ) {return methods.init.apply( this, arguments );}
		else {console.log( "Method " +  method + " does not exist on calendar" );}    
	};
