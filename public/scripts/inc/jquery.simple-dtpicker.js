 ...
 (function($) {
	...
	**/
			...
			if (
                ...
                */
				...
				$td.click(function() {
                    ...
                    var func = $picker.data('onSelectDate');
                    if (func != null) {
                        // func();
                        func();
                    }
	...
	var init = function($obj, opt) {
        ...
        $picker.data('onSelectDate', opt.onSelectDate);
		...
		return this.each(function(i) {
			...
			if(options.inline === true){
                ...
                $(input).on('blur', function(){
                    ...
                    // Generate the handler of a picker
                    var handler = new PickerHandler($picker, $input);
                    tmp_PickerHandler = handler;

                    setTimeout('if ( tmp_PickerHandler != null ){tmp_PickerHandler.hide();}', 300);
                });
