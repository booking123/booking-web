        ...
        <div class="row">
            <div class="col-lg-12">
                <nav class="navbar" role="navigation">
                    <a class="navbar-brand" href="{{ url('home/') }}"><img src="{{ unique_logo }}"></a>
		...
		<div class="container">
			<div class="search-panel">
				<div class="row">
					...
					<div class="search-panel-input-box col-sm-2">
						<button type="submit" class="btn btn-success" ng-click="processSearch()" id="home_search_button">Search</button>
					</div>
				...
				<div class="search-panel-input-box col-md-7 col-sm-6">
					...
					<div class="row amenities">
						...
						<div class="col-md-5 col-sm-12 text-right search-advanced-buttons">
                            ...
                            <button type="submit" class="btn btn-success" ng-click="advancedSearch.go()">Apply Filters</button>
						</div>
					</div>
				</div>
        ...
        <div ng-class="params.search_result_type == 'list' ? 'col-md-12' : 'col-md-4 col-sm-6 col-sx-12'"
            ...
            <div class="result-item">
                ...
                <div class="item-advanced-box">
                    ...
                    <ul class="advanced-info " ng-show="product.managerName">
                        <li>Managed by <span>[[ product.managerName ]]</span></li>
                    </ul>
                    <div class="advanced-footer">
                        <span class="book-it-now  hidden-xs" ng-hide="product.inquiryOnly == true">Book it Online</span>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 result-left-column">
                ...
                <div class="result-left-column-overview result-block-style" ng-show="product_info.description.length>9">
                    <h4 class="detail-heading">Overview</h4>
                    <div class="content list" ng-bind-html="product_info.description | html"></div>
                </div>
                ...
                <div class="result-block-style" ng-show="product_info.fees.included || product_info.fees.excluded">
                    <div ng-show="product_info.fees.included">
                        ...
                        <ul>
                            <li ng-repeat="i in product_info.fees.included">[[ i.text ]] [[  i.price  ]]</li>
                        </ul>
                    </div>
                    <div ng-show="product_info.fees.excluded">
                        <h4 class="detail-heading">Excluded</h4>
                        <b style="margin-left: 40px;">*Any extra cost will be charged by the host at the property's currency</b>
                        <ul>
                ...
                <div class="result-book-panel">
                    <div class="result-book-panel-price result-block-style">
                        ...
                        <div class="result-book-panel-button" ng-hide="error || params.detailApiCount < params.detailApiNum">
                            <a href="javascript:void(0);" ng-hide="product_info.inquire == true" ng-click="showBookingWidget();" class="btn btn-default">Book Now</a>
                            <a href="javascript:void(0);" ng-hide="product_info.inquire == false" ng-click="showInquireDialog();" class="btn btn-default">Email Owner</a>
                        </div>
                    </div>
