...
(function( $ ) {
	...
	function refresh (e) {
		...
		if (settings.error) console.log("product " + settings.pos + ", " + settings.model + ", " + settings.id + ", " + settings.error);
		...
		.error(function(data) {if (settings.error) console.log("product error");});
	}
})( jQuery );
